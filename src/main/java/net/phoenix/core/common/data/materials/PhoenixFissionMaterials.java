...
public class PhoenixFissionMaterials {
    ...
    public static void register() {
         ...
         * .buildAndRegister();
         * 
         * NIOBIUM_MODIFIED_SILICON_CARBIDE = new
         * Material.Builder(PhoenixFission.id("niobium_modified_silicon_carbide"))
         * .ingot()
         * .color(0x4A4B6B)
         ...
         * .buildAndRegister();
         * 
         * PURIFIED_RADIOACTIVE_WASTE_FLUID = new
         * Material.Builder(PhoenixFission.id("purified_radioactive_waste_fluid"))
         * .fluid()
         * .color(0x3B5323)
         * .iconSet(MaterialIconSet.DULL)
         * .buildAndRegister();
